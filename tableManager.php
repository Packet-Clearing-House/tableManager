...
/**
 * Class tableManager version 1.0
 ...
 * Many methods in this class with throw an error - wrap all calls in try/catch.
 * Required:
...
class tableManager {
    ...
    var $db, $username, $host, $password, $database, $type, $port, $schema, $table;
     ...
     * @param $rows associative array of rows returned from getRowsFromTable()
